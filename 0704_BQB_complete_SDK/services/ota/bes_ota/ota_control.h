...
#define LOG_DBG(num,str,...)   TRACE(num,str, ##__VA_ARGS__)             // DEBUG OUTPUT
#define LOG_MSG(num,str,...)   TRACE(num,str, ##__VA_ARGS__)             // MESSAGE OUTPUT
#define LOG_ERR(num,str,...)   TRACE(num,str, ##__VA_ARGS__)       // ERROR OUTPUT
